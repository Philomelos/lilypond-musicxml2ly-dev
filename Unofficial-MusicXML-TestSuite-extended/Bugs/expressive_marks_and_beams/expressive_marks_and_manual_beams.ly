...
\header {
  texidoc = "musicxml2ly places expressive marks 
                such as breath marks, dynamics, fermatas within manual beam brackets which 
                all cause fatal errors during compilation. Temporary workaround: use musicxml2ly 

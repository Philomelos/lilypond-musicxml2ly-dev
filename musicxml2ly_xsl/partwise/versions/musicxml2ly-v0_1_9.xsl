...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- musicxml2ly.xsl v0.1.9 (12.10.2013) -->
    <!-- Dictionaries -->
    <!-- octave dictionary -->
            ...
            <xsl:for-each select="measure">
                    ...
                    <xsl:for-each select="key">
                        ...
                        <xsl:choose>
                            <xsl:when test="fifths = '0' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='0_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='0_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0'">
                                <xsl:value-of select="$key/entry[@key='0_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='0_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='0_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='0_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='0_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='0_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='0_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '0' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='0_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '1' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='1_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='1_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1'">
                                <xsl:value-of select="$key/entry[@key='1_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='1_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='1_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='1_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='1_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='1_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='1_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '1' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='1_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '2' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='2_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='2_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2'">
                                <xsl:value-of select="$key/entry[@key='2_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='2_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='2_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='2_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='2_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='2_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='2_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '2' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='2_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '3' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='3_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='3_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3'">
                                <xsl:value-of select="$key/entry[@key='3_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='3_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='3_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='3_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='3_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='3_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='3_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '3' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='3_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '4' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='4_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='4_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4'">
                                <xsl:value-of select="$key/entry[@key='4_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='4_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='4_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='4_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='4_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='4_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='4_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '4' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='4_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '5' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='5_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='5_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5'">
                                <xsl:value-of select="$key/entry[@key='5_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='5_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='5_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='5_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='5_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='5_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='5_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '5' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='5_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '6' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='6_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='6_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6'">
                                <xsl:value-of select="$key/entry[@key='6_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='6_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='6_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='6_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='6_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='6_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='6_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '6' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='6_locrian']"/>
                            </xsl:when>
                            
                            <xsl:when test="fifths = '7' and mode = 'major' or mode=''">
                                <xsl:value-of select="$key/entry[@key='7_major']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'ionian'">
                                <xsl:value-of select="$key/entry[@key='7_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7'">
                                <xsl:value-of select="$key/entry[@key='7_ionian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'dorian'">
                                <xsl:value-of select="$key/entry[@key='7_dorian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='7_phrygian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='7_lydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'mixolydian'">
                                <xsl:value-of select="$key/entry[@key='7_mixolydian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'minor'">
                                <xsl:value-of select="$key/entry[@key='7_minor']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'aeolian'">
                                <xsl:value-of select="$key/entry[@key='7_aeolian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '7' and mode = 'locrian'">
                                <xsl:value-of select="$key/entry[@key='7_locrian']"/>
                            </xsl:when>
                            ...
                            <xsl:when test="fifths = '-7' and mode = 'phrygian'">
                                <xsl:value-of select="$key/entry[@key='-7_phyrgian']"/>
                            </xsl:when>
                            <xsl:when test="fifths = '-7' and mode = 'lydian'">
                                <xsl:value-of select="$key/entry[@key='-7_lydian']"/>
                            </xsl:when>
                    ...
                    <xsl:for-each select="clef">
                        ...
                        <xsl:choose>
                            <xsl:when test="sign = 'F' and line='3'">
                                <xsl:value-of select="$clef/entry[@key='F_3']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'F' and line='4'">
                                <xsl:value-of select="$clef/entry[@key='F_4']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'F' and line='4' and clef-octave-change='-1'">
                                <xsl:value-of select="$clef/entry[@key='F_4_-1']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'F' and line='4' and clef-octave-change='-2'">
                                <xsl:value-of select="$clef/entry[@key='F_4_-2']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'F' and line='4' and clef-octave-change='2'">
                                <xsl:value-of select="$clef/entry[@key='F_4_2']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'F' and line='5'">
                                <xsl:value-of select="$clef/entry[@key='F_5']"/>
                            </xsl:when>
                            
                            <xsl:when test="sign = 'G' and line='1'">
                                <xsl:value-of select="$clef/entry[@key='G_1']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'G' and line='2'">
                                <xsl:value-of select="$clef/entry[@key='G_2']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'G' and line='2' and clef-octave-change='-1'">
                                <xsl:value-of select="$clef/entry[@key='G_2_-1']"/>
                            </xsl:when>
     
                            <xsl:when test="sign = 'C' and line='1'">
                                <xsl:value-of select="$clef/entry[@key='C_1']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'C' and line='2'">
                                <xsl:value-of select="$clef/entry[@key='C_2']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'C' and line='3'">
                                <xsl:value-of select="$clef/entry[@key='C_3']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'C' and line='4'">
                                <xsl:value-of select="$clef/entry[@key='C_4']"/>
                            </xsl:when>
                            <xsl:when test="sign = 'C' and line='5'">
                                <xsl:value-of select="$clef/entry[@key='C_5']"/>
                            </xsl:when>
                            
                            <xsl:when test="sign = 'percussion' and line='4'">
                                <xsl:value-of select="$clef/entry[@key='percussion']"/>
                            </xsl:when>
                            
                            <xsl:when test="sign = 'TAB' and line='5'">
                                <xsl:value-of select="$clef/entry[@key='TAB_5']"/>
                            </xsl:when>
                        </xsl:choose>
                        <xsl:text>
      </xsl:text>
                ...
                <xsl:for-each select="note">
                    <xsl:for-each select="pitch">
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="octave = '0'">
                                <xsl:value-of select="$octave/entry[@key='0']"/>
                            </xsl:when>
                            <xsl:when test="octave = '1'">
                                <xsl:value-of select="$octave/entry[@key='1']"/>
                            </xsl:when>
                            <xsl:when test="octave = '2'">
                                <xsl:value-of select="$octave/entry[@key='2']"/>
                            </xsl:when>
                            <xsl:when test="octave = '3'">
                                <xsl:value-of select="$octave/entry[@key='3']"/>
                            </xsl:when>
                            <xsl:when test="octave = '4'">
                                <xsl:value-of select="$octave/entry[@key='4']"/>
                            </xsl:when>
                            <xsl:when test="octave = '5'">
                                <xsl:value-of select="$octave/entry[@key='5']"/>
                            </xsl:when>
                            <xsl:when test="octave = '6'">
                                <xsl:value-of select="$octave/entry[@key='6']"/>
                            </xsl:when>
                            <xsl:when test="octave = '7'">
                                <xsl:value-of select="$octave/entry[@key='7']"/>
                            </xsl:when>
                            <xsl:when test="octave = '8'">
                                <xsl:value-of select="$octave/entry[@key='8']"/>
                            </xsl:when>
                            <xsl:when test="octave = '9'">
                                <xsl:value-of select="$octave/entry[@key='9']"/>
                            </xsl:when>
                        </xsl:choose>
                    ...
                    <xsl:choose>
                        ...
                        -->
                        <xsl:when test="rest/display-step and type='128th'"><xsl:value-of select="$type/entry[@key='128th']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='64th'"><xsl:value-of select="$type/entry[@key='64th']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='32nd'"><xsl:value-of select="$type/entry[@key='32nd']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='16th'"><xsl:value-of select="$type/entry[@key='16th']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='eighth'"><xsl:value-of select="$type/entry[@key='eighth']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='quarter'"><xsl:value-of select="$type/entry[@key='quarter']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='half'"><xsl:value-of select="$type/entry[@key='half']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='whole'"><xsl:value-of select="$type/entry[@key='whole']"/>\rest</xsl:when>
                        <xsl:when test="rest/display-step and type='breve'"><xsl:value-of select="$type/entry[@key='breve']"/>\rest</xsl:when>
                        <xsl:when test="type='128th'"><xsl:value-of select="$type/entry[@key='128th']"/></xsl:when>
                        <xsl:when test="type='64th'"><xsl:value-of select="$type/entry[@key='64th']"/></xsl:when>
                        <xsl:when test="type='32nd'"><xsl:value-of select="$type/entry[@key='32nd']"/></xsl:when>
                        <xsl:when test="type='16th'"><xsl:value-of select="$type/entry[@key='16th']"/></xsl:when>
                        <xsl:when test="type='eighth'"><xsl:value-of select="$type/entry[@key='eighth']"/></xsl:when>
                        <xsl:when test="type='quarter'"><xsl:value-of select="$type/entry[@key='quarter']"/></xsl:when>
                        <xsl:when test="type='half'"><xsl:value-of select="$type/entry[@key='half']"/></xsl:when>
                        <xsl:when test="type='whole'"><xsl:value-of select="$type/entry[@key='whole']"/></xsl:when>
                        <xsl:when test="type='breve'"><xsl:value-of select="$type/entry[@key='breve']"/></xsl:when>
                        <!--
                ...
                <xsl:for-each select="barline">
                    ...
                    <xsl:choose>
                        <xsl:when test="../barline[@location='right'] and bar-style='regular'">
                            <xsl:value-of select="$barline/entry[@key='right_regular']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='dotted'">
                            <xsl:value-of select="$barline/entry[@key='right_dotted']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='dashed'">
                            <xsl:value-of select="$barline/entry[@key='right_dashed']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='heavy'">
                            <xsl:value-of select="$barline/entry[@key='right_heavy']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='light-light'">
                            <xsl:value-of select="$barline/entry[@key='right_light-light']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='light-heavy'">
                            <xsl:value-of select="$barline/entry[@key='right_light-heavy']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='left'] and bar-style='heavy-light'">
                            <xsl:value-of select="$barline/entry[@key='left_heavy-light']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='right'] and bar-style='heavy-heavy'">
                            <xsl:value-of select="$barline/entry[@key='right_heavy-heavy']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='middle'] and bar-style='tick'">
                            <xsl:value-of select="$barline/entry[@key='middle_tick']"/>
                        </xsl:when>
                        ...
                        <xsl:when test="../barline[@location='middle'] and bar-style='short'">
                            <xsl:value-of select="$barline/entry[@key='middle_short']"/>
                        </xsl:when>

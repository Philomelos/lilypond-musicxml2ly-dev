...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="version">musicxml2ly.xsl v0.1.14-2 (02.11.2013)</xsl:variable>
    ...
    <xsl:variable name="accidentals">
        ...
        <entry key="double-sharp">
            <xsl:text>^\markup { \doublesharp }</xsl:text>
        </entry>
        <entry key="bracket_double-sharp">
            <xsl:text>^\markup \bracket { \doublesharp }</xsl:text>
        </entry>
        <entry key="parentheses_double-sharp">
            <xsl:text>^\markup \parenthesize { \doublesharp }</xsl:text>
        </entry>
        <!--
        ...
        <entry key="sharp-down">
            <xsl:text>^\markup { \musicglyph #"accidentals.sharp.arrowdown" }</xsl:text>
        </entry>
        <entry key="bracket_sharp-down">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.sharp.arrowdown" }</xsl:text>
        </entry>
        <entry key="parentheses_sharp-down">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.sharp.arrowdown" }</xsl:text>
        </entry>
        <!--
        <entry key="sharp-up">???</entry>
        -->
        <entry key="sharp-up">
            <xsl:text>^\markup { \musicglyph #"accidentals.sharp.arrowup" }</xsl:text>
        </entry>
        <entry key="bracket_sharp-up">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.sharp.arrowup" }</xsl:text>
        </entry>
        <entry key="parentheses_sharp-up">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.sharp.arrowup" }</xsl:text>
        </entry>
        <!--
        <entry key="natural-down">???</entry>
        -->
        <entry key="natural-down">
            <xsl:text>^\markup { \musicglyph #"accidentals.natural.arrowdown" }</xsl:text>
        </entry>
        <entry key="bracket_natural-down">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.natural.arrowdown" }</xsl:text>
        </entry>
        <entry key="parentheses_natural-down">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.natural.arrowdown" }</xsl:text>
        </entry>
        <!--
        <entry key="natural-up">???</entry>
        -->
        <entry key="natural-up">
            <xsl:text>^\markup { \musicglyph #"accidentals.natural.arrowup" }</xsl:text>
        </entry>
        <entry key="bracket_natural-up">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.natural.arrowup" }</xsl:text>
        </entry>
        <entry key="parentheses_natural-up">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.natural.arrowup" }</xsl:text>
        </entry>
        <!--
        <entry key="flat-down">???</entry>
        -->
        <entry key="flat-down">
            <xsl:text>^\markup { \musicglyph #"accidentals.flat.arrowdown" }</xsl:text>
        </entry>
        <entry key="bracket_flat-down">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.flat.arrowdown" }</xsl:text>
        </entry>
        <entry key="parentheses_flat-down">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.flat.arrowdown" }</xsl:text>
        </entry>
        <!--
        <entry key="flat-up">???</entry>
        -->
        <entry key="flat-up">
            <xsl:text>^\markup { \musicglyph #"accidentals.flat.arrowup" }</xsl:text>
        </entry>
        <entry key="bracket_flat-up">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.flat.arrowup" }</xsl:text>
        </entry>
        <entry key="parentheses_flat-up">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.flat.arrowup" }</xsl:text>
        </entry>
        <!--
        <entry key="triple-sharp">???</entry>
        -->
        <entry key="triple-sharp">
            <xsl:text>^\markup { \concat { \sharp\doublesharp }? }</xsl:text>
            <!--
            <xsl:text>^\markup { \concat { \sharp\sharp\sharp }? }</xsl:text>
            -->
        </entry>
        <entry key="bracket_triple-sharp">
            <xsl:text>^\markup \bracket { \concat { \sharp\doublesharp }? }</xsl:text>
            <!--
            <xsl:text>^\markup \bracket { \concat { \sharp\sharp\sharp }? }</xsl:text>
            -->
        </entry>
        <entry key="parentheses_triple-sharp">
            <xsl:text>^\markup \parenthesize { \concat { \sharp\doublesharp }? }</xsl:text>
            <!--
            <xsl:text>^\markup \parenthesize { \concat { \sharp\sharp\sharp }? }</xsl:text>
            -->
        </entry>
        <!--
        ...
        <entry key="triple-flat">
            <xsl:text>^\markup { \concat { \flat\flat\flat } ? }</xsl:text>
        </entry>
        <entry key="bracket_triple-flat">
            <xsl:text>^\markup \bracket { \concat { \flat\flat\flat } ? }</xsl:text>
        </entry>
        <entry key="parentheses_triple-flat">
            <xsl:text>^\markup \parenthesize { \concat { \flat\flat\flat } ? }</xsl:text>
        </entry>
        <!-- 
        ...
        <entry key="slash-quarter-sharp">
            <xsl:text>^\markup {  \musicglyph #"accidentals.sharp.slashslashslash.stem" }</xsl:text>
        </entry>
        <entry key="bracket_slash-quarter-sharp">
            <xsl:text>^\markup \bracket {  \musicglyph #"accidentals.sharp.slashslashslash.stem" }</xsl:text>
        </entry>
        <entry key="parentheses_slash-quarter-sharp">
            <xsl:text>^\markup \parenthesize {  \musicglyph #"accidentals.sharp.slashslashslash.stem" }</xsl:text>
        </entry>
        <!--
        <entry key="slash-sharp">???</entry>
        -->
        <entry key="slash-sharp">
            <xsl:text>^\markup { \musicglyph #"accidentals.sharp.slashslashslash.stemstem" }</xsl:text>
        </entry>
        <entry key="bracket_slash-sharp">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.sharp.slashslashslash.stemstem" }</xsl:text>
        </entry>
        <entry key="parentheses_slash-sharp">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.sharp.slashslashslash.stemstem" }</xsl:text>
        </entry>
        <!--
        <entry key="slash-flat">???</entry>
        -->
        <entry key="slash-flat">
            <xsl:text>^\markup { \musicglyph #"accidentals.flat.slash" }</xsl:text>
        </entry>
        <entry key="bracket_slash-flat">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.flat.slash" }</xsl:text>
        </entry>
        <entry key="parentheses_slash-flat">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.flat.slash" }</xsl:text>
        </entry>
        <!--
        <entry key="double-slash-flat">???</entry>
        -->
        <entry key="double-slash-flat">
            <xsl:text>^\markup { \musicglyph #"accidentals.flat.slashslash" }</xsl:text>
        </entry>
        <entry key="bracket_double-slash-flat">
            <xsl:text>^\markup \bracket { \musicglyph #"accidentals.flat.slashslash" }</xsl:text>
        </entry>
        <entry key="parentheses_double-slash-flat">
            <xsl:text>^\markup \parenthesize { \musicglyph #"accidentals.flat.slashslash" }</xsl:text>
        </entry>
        <!--
    ...
    <xsl:template name="decimal-to-fraction">
        ...
        <xsl:choose>
            <!-- 
                ...
                they should be filled up with suitable rest durations.
                This actually happens in the measure-completion template
                but as I'm using \repeat unfold $num { r$dom } for it
                we need a condition to output fractions in this way:
                $num { r$dom }.
            -->
            <xsl:when test="
                ./attributes/time/beats
                ...
                *
                ...
                <xsl:value-of select="$num div $gcd"/>
                    <xsl:text> { r</xsl:text><xsl:value-of select="$dom div $gcd"/>
                    <xsl:text> } </xsl:text>
            </xsl:when>

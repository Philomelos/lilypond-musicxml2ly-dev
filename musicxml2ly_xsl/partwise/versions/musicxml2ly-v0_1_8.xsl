...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- musicxml2ly.xsl v0.1.8 (11.10.2013) -->
    <!-- Dictionaries -->
    <!-- octave dictionary -->
    ...
    <xsl:variable name="barline">
        <entry key="rightregular">\bar "|"</entry>
        <entry key="rightdotted">\bar ";"</entry>
        <entry key="rightdashed">\bar "!"</entry>
        <entry key="rightheavy">\bar "."</entry>
        <entry key="rightlight-light">\bar "||"</entry>
        <entry key="rightlight-heavy">\bar "|."</entry>
        <entry key="rightheavy-light">\bar ".|"</entry>
        <entry key="rightheavy-heavy">\bar ".."</entry>
        <entry key="middletick">\bar "'"</entry>
        <entry key="middleshort">\once\override Staff.BarLine.bar-extent = #'(-1 . 1)</entry>
    </xsl:variable>
    
    <!-- <key> signature dictionary (<fifths> and <mode>) -->
    <xsl:variable name="key">
        <entry key="0major">\key c\major</entry>
        <entry key="0ionian">\key c\major</entry>
        <entry key="0dorian">\key d\dorian</entry>
        <entry key="0phrygian">\key e\phrygian</entry>
        <entry key="0lydian">\key f\lydian</entry>
        <entry key="0mixolydian">\key g\mixolydian</entry>
        <entry key="0minor">\key a\minor</entry>
        <entry key="0aeolian">\key a\aeolian</entry>
    </xsl:variable>
